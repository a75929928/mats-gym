...
# Set python path
# WORK_DIR = os.getenv('2', 'D:\Code\.SOTA\TCP')
# PYTHONPATH = os.environ.get('PYTHONPATH', '')

# PYTHONPATH += f'{WORK_DIR}'
# PYTHONPATH += f'{WORK_DIR}\\leaderboard'

# os.environ['PYTHONPATH'] = PYTHONPATH
import sys
sys.path.append("D:\Code\.SOTA\TCP\leaderboard")
from team_code.tcp_agent import TCPAgent

sys.path.append("D:\Code\.SOTA\TCP")
...
def main():
    ...
    agent = TCPAgent(role_name=actor_config.rolename, carla_host="localhost", carla_port=2000)
    ...
    for _ in range(100):
        ...
        agent.setup(path_to_conf_file="D:\Code\.SOTA\TCP\pretrained_model\\new.ckpt", route=env.current_actor_config.route)
