...
import sys
sys.path.append("D:\Code\.SOTA\\transfuser\\team_code_transfuser")
from submission_agent_origin import HybridAgent
...
def main():
    ...
    agent = HybridAgent(role_name=actor_config.rolename, carla_host="localhost", carla_port=2000)
