...
def main():
    ...
    agent = SensorAgent(role_name=actor_config.rolename, carla_host="localhost", carla_port=2000)
    ...
    for _ in range(100):
        ...
        agent.setup(path_to_conf_file="D:\Code\.SOTA\carla_garage\pretrained_models\longest6\plant_all_1\config.pickle", route=env.current_actor_config.route)
