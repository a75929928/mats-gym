...
import csv
"""
This example shows how to use the BaseScenarioEnv class to generate random routes
"""
...
# Randomly set spawn points
def spawn_points(csv_path):
    csv_path = "D:\Code\carla\mats-gym\spawn_points\Town04.csv"
...
def main():
    ...
    agent = AutopilotAgent(role_name=config.ego_vehicles[0].rolename, carla_host="127.0.0.1", carla_port=2000)
    ...
    for _ in range(NUM_EPISODES):
        ...
        obs, info = env.reset(options={"client": carla.Client("127.0.0.1", 2000)})
